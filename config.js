const CONFIG = {
    ...
    btnYes: 'Cute quá tr ròi <3',
    btnNo: 'Ùa cũng tạm ',
    question: 'Hiện tại em muốn tìm cổ đông "xây dựng" cty này, a đồng ý chớ',
    btnReply: 'apply neeeee',
    reply: 'Đồng ý chớ, cutee z màaaaa',
    mess: 'Hic hic củm ơn anh nhìu',
    messDesc: 'Em còn muốn thay đổi bản thân mình rất rất nhiều, và nếu em may mắn em có thể tìm được động lực của riêng em',
    btnAccept: 'Anh bít ròiiii',
